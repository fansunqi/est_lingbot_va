...
va_test_train_cfg.dataset_path = '/apdcephfs_gy2/share_303214312/leoyizhang/datasets/droid_test'
...
# Training parameters
va_test_train_cfg.learning_rate = 1e-5
...
va_test_train_cfg.batch_size = 1
va_test_train_cfg.gradient_accumulation_steps = 1
va_test_train_cfg.num_steps = 1000000
